...
//        simpleExoPlayer.prepare(sourceList);
        initListener();
    }
...
//                show=true;
//                Toast.makeText(SpeechSimulationActivity.this, "播放完结", Toast.LENGTH_SHORT).show();
            }
        }
    };

    public void setOnAutioControlListener(AutioControlListener listener) {
